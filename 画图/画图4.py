...
# 绘制不同算法的加速比
plt.plot(n, speedup_opt2, marker='o', label="2路链式求和", linestyle='-', color='b')
plt.plot(n, speedup_opt4, marker='s', label="4路链式求和", linestyle='-', color='g')
plt.plot(n, speedup_opt2_unrolled, marker='^', label="2路链式求和循环展开", linestyle='-', color='r')
plt.plot(n, speedup_opt4_unrolled, marker='D', label="4路链式求和循环展开", linestyle='-', color='c')
